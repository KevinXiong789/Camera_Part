...
def right_hand_position():
	for skeleton in data.skeletons:
		right_x=skeleton.right_hand.real[0]
		right_y=skeleton.right_hand.real[2]
		right_z=skeleton.right_hand.real[1]
		print("right hand x: %f, y: %f, z: %f"%(right_x,right_y,right_z))
